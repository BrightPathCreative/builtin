...
export const metadata = createMetadata({
  ...
  description:
    "Privacy information for Built In. Melbourne website enquiries and contact form submissions.",
  path: "/privacy-policy",
});
  ...
  return (
    <>
      ...
      <section className="section-shell legal-page reveal">
        ...
        <h2>Form Provider</h2>
        <p>
          The contact form is provided by Web3Forms. Information submitted through
          the form may be processed by that provider so the enquiry can be received
          and managed.
        </p>
